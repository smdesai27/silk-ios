...
enum FuzzCorpusR3Data {
    ...
    static let rows_conversation: [FuzzCorpusRow] = [
        ...
        FuzzCorpusRow(source: "conversation", index: 1, utterance: "hey silk its been a rough day gimme fifteen minutes of insta and then ill stop i promise", stateSpec: nil, expect: "VERDICT GRANT door=instagram minutes=15"),
        ...
        FuzzCorpusRow(source: "conversation", index: 3, utterance: "so anyway long story short i need like 10 minutes of insta to check something", stateSpec: nil, expect: "VERDICT GRANT door=instagram minutes=10"),
        FuzzCorpusRow(source: "conversation", index: 4, utterance: "i know i said i was done earlier but tiktok for ten please", stateSpec: nil, expect: "VERDICT GRANT door=tiktok minutes=10"),
        ...
        FuzzCorpusRow(source: "conversation", index: 14, utterance: "give me ten of insta then close it after", stateSpec: nil, expect: "VERDICT GRANT door=instagram minutes=10"),
        ...
        FuzzCorpusRow(source: "conversation", index: 22, utterance: "close tiktok actually no keep it open", stateSpec: nil, expect: "VERDICT REFUSE_HOW_LONG"),
        ...
        FuzzCorpusRow(source: "conversation", index: 28, utterance: "reddit ten ok bye love you", stateSpec: nil, expect: "VERDICT GRANT door=reddit minutes=10"),
        FuzzCorpusRow(source: "conversation", index: 29, utterance: "ok done with insta for tonight goodnight", stateSpec: nil, expect: "VERDICT CLOSE door=instagram until=day-boundary"),
        ...
        FuzzCorpusRow(source: "conversation", index: 51, utterance: "dont give me tiktok", stateSpec: nil, expect: "VERDICT REFUSE_HOW_LONG"),
        FuzzCorpusRow(source: "conversation", index: 52, utterance: "whatever you do do not open instagram tonight", stateSpec: nil, expect: "VERDICT REFUSE_HOW_LONG"),

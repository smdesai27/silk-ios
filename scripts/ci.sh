...
# as it does here — 1,050 of the repo's 1,187 cases, one short of the spine's whole
# 1,051 because a single Darwin-shaped ratio names itself and skips. That is

...
# as it does here — 1,030 of the repo's 1,167 cases, one short of the spine's whole
# 1,031 because a single Darwin-shaped ratio names itself and skips. That is
